...
import 'package:feature_auth/src/presentation/controllers/login_controller.dart';
...
void main() {
  ...
  group('LoginController 基础状态', () {
    test('默认使用密码登录', () {
      final viewModel = LoginController(repository);
  ...
  group('LoginController signals 语义', () {
