...
///
/// 状态：ViewModel 暴露 signals，页面用 [SignalBuilder] **按区域订阅**——
...
class _LoginPageState extends State<LoginPage> {
  late final LoginViewModel _viewModel = LoginViewModel(widget.repository);
        ...
        children: <Widget>[
          SignalBuilder(
            builder: (context) => AppSegmentedControl<LoginMode>(
              ...
              groupValue: _viewModel.mode.value,
              onChanged: _viewModel.switchMode,
            ),
          ),
          const SizedBox(height: AppSpacing.xl),
          SignalBuilder(
          ...
          SignalBuilder(
            builder: (context) => _viewModel.isPasswordMode.value
                ? _buildPasswordField()
                : _buildSmsCodeField(),
          ),
          SignalBuilder(
  ...
  Widget _buildPasswordField() {
    return AppTextField(
      ...
      onToggleObscure: _viewModel.togglePasswordVisibility,
      ...
      errorText: _viewModel.passwordError.value,
    );
  }
