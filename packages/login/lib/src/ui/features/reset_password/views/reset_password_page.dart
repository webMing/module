...
import '../../../core/widgets/countdown_code_button.dart';
import '../../../core/widgets/demo_hint.dart';
...
///
/// 状态：ViewModel 暴露 signals，页面用 [SignalBuilder] 按字段订阅，输入时只重建
...
class _ResetPasswordPageState extends State<ResetPasswordPage> {
  late final ResetPasswordViewModel _viewModel = ResetPasswordViewModel(
    widget.repository,
  );
            ...
            children: <Widget>[
              ...
              SignalBuilder(
                builder: (context) => DemoHint(
                  ...
                  debugSmsCode: _viewModel.debugSmsCode.value,
                ),
              ),
            ],
          ),
        ...
        children: <Widget>[
          SignalBuilder(
            builder: (context) => AppTextField(
              ...
              onChanged: _viewModel.updateAccount,
              errorText: _viewModel.accountError.value,
            ),
          ),
          ...
          SignalBuilder(
            builder: (context) => AppTextField(
              ...
              onChanged: _viewModel.updateSmsCode,
              errorText: _viewModel.smsCodeError.value,
              suffix: SignalBuilder(
                builder: (context) => CountdownCodeButton(
                  buttonKey: const Key('reset_send_code_button'),
                  countdownSeconds: _viewModel.countdownSeconds.value,
                  isSending: _viewModel.isSendingCode.value,
                  onPressed: _viewModel.sendSmsCode,
                ),
              ),
            ),
          ),
          ...
          SignalBuilder(
            builder: (context) => AppTextField(
              ...
              obscureText: _viewModel.obscureNewPassword.value,
              onToggleObscure: _viewModel.toggleNewPasswordVisibility,
              textInputAction: TextInputAction.next,
              inputFormatters: <TextInputFormatter>[
                FilteringTextInputFormatter.allow(
              ...
              onChanged: _viewModel.updateNewPassword,
              errorText: _viewModel.newPasswordError.value,
            ),
          ),
          Padding(
          ...
          SignalBuilder(
            builder: (context) => AppTextField(
              ...
              placeholder: '再次输入新密码',
              obscureText: _viewModel.obscureConfirmPassword.value,
              onToggleObscure: _viewModel.toggleConfirmPasswordVisibility,
              ...
              errorText: _viewModel.confirmPasswordError.value,
            ),
          ),
          SignalBuilder(
            builder: (context) {
              final message = _viewModel.errorMessage.value;
              if (message == null) {
          ...
          SignalBuilder(
            builder: (context) => AppPrimaryButton(
              ...
              label: '确认重置',
              isLoading: _viewModel.isSubmitting.value,
              onPressed: _submit,
            ),
          ),
        ],
