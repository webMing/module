...
void main() {
  ...
  group('ResetPasswordViewModel 校验', () {
    test('空输入提交时给出全部字段错误', () async {
      final viewModel = ResetPasswordViewModel(repository);
  ...
  group('ResetPasswordViewModel 提交流程', () {
  ...
  group('ResetPasswordViewModel signals 语义', () {
